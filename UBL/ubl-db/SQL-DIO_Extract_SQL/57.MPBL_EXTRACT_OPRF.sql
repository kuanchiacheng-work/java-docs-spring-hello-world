SELECT 'OPRF' oprf, RPAD (TRIM (ba.acct_id), 12, ' ') billing_arrangement_id,
       ...
       RPAD (TRIM (fet1_refund_request.refund_reason), 10, ' ') refund_reason
 ...
 WHERE ba.bill_seq = ${billSeq}
   ...
   AND ba.bill_seq = fet1_invoice.bill_seq_no
   ...
   AND fet1_refund_request.account_id = fet1_invoice.account_id
   AND fet1_refund_request.invoice_id = fet1_invoice.invoice_id
   AND fet1_refund_request.transaction_id = fet1_invoice.transaction_id
   AND 'B' = ${procType}
