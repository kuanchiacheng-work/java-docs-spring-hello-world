SELECT 'OPRR' oprr, RPAD (TRIM (ba.acct_id), 12, ' ') billing_arrangement_id,
 ...
 WHERE ba.bill_seq =  ${billSeq}
   ...
   AND fet1_refund_request.account_id = fet1_customer_credit.account_id
   AND fet1_refund_request.reversal_trans_id = fet1_customer_credit.transaction_id
   AND 'B' = ${procType}
