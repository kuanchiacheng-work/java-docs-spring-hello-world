...
CASE 
  ...
  THEN (SELECT ORG.TXN_ID FROM FY_TB_BL_BILL_CI CI,
  ...
  THEN substrb(bi.dynamic_attribute,
               instrb(bi.dynamic_attribute, '=', instrb(bi.dynamic_attribute,'TXN_ID',1,1), 1)+1,
               instrb(bi.dynamic_attribute, '#', instrb(bi.dynamic_attribute,'TXN_ID',1,1), 1)-instrb(bi.dynamic_attribute, '=', 
               instrb(bi.dynamic_attribute,'TXN_ID',1,1), 1)-1
              )                                  
END AS TXN_ID,
'' CSP_SERVICE_ID,
