...
DECODE(MAST.PAYMENT_METHOD ,'DD',MAST.HOLDER_NAME,NULL) HOLDER_ID,--SR222460 MPBS migrate to HGB
...
WHERE ct.BILL_SEQ   = ${billSeq}
  ...
  AND MAST.INVOICE_TYPE !='S' --SR222460 MPBS migrate to HGB
  AND MAST.TOT_AMT> 0         --SR222460 MPBS migrate to HGB
